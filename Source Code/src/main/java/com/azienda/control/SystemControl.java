...
//======================================================================
     ...
     */
    public static boolean checkStartTime(String expected, String actual) {
        DatabaseControl DBMS = new DatabaseControl();

        /* Time is in format HH:MM */

        /* Get the starting time of the shift: Start at 08:00 -> 07:50 */
        int shiftHour = Integer.parseInt(expected.substring(0, 2));
        int shiftMinutes = Integer.parseInt(expected.substring(4));
        ...
        int startHourEmp = Integer.parseInt(actual.substring(0, 2));
        int startMinutesEmp = Integer.parseInt(actual.substring(4));
...
//=============================================
    ...
    public static void changeShift(AbstentionRequest request) {
        ...
        ArrayList<Integer> freeEmployees;
        ...
        for (int i = 1; i <= weeksBetween; ++i) {
            ...
            if (workingDaysTemp == null) {
                System.err.println("ExitControl procedure, no working days available!");
                return;
            }

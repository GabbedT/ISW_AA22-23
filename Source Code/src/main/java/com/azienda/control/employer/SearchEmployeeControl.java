...
public class SearchEmployeeControl implements Initializable {
        @FXML
        ...
        public void initialize(URL url, ResourceBundle resource){
                ...
                if (list.isEmpty()) {
                        showErrorPanel("No employees found in database");
                }
        }
        ...
        void ButtonConfirm(ActionEvent event) {
                ...
                try {
                        FXMLLoader fxmlLoader = new FXMLLoader(SearchEmployeeControl.class.getResource("FireEmployeeModule.fxml"));
                        Parent root1 = (Parent) fxmlLoader.load();
                        Stage stage = new Stage();
                        stage.setScene(new Scene(root1));
                        stage.show();

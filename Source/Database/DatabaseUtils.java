...
public final class DatabaseUtils {
    ...
    /**
     * Insert an User row into the database
     * 
     * @param usr An User object that holds the fields
     * @return A string for the SQL statement
     */
    public static String insertUser(User usr) {
        return "INSERT INTO Employer " + userFields + 
     ...
     * 
     * @param notif An Notification object that holds the fields
     * @return A string for the SQL statement
     */
     ...
     * 
     * @param req An Shift object that holds the fields
     * @return A string for the SQL statement
     */
     ...
     * @return A string that rapresent the integer value
     */
     ...
     * @return A string that rapresent the boolean value
     */
    private static String SQLvalue(Boolean var) {
